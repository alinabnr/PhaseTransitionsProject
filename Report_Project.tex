...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.1.png}
        \caption{$\beta = 0.1$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.2.png}
        \caption{$\beta = 0.2$}
    \end{subfigure}

    % Row 2
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.3.png}
        \caption{$\beta = 0.3$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.4.png}
        \caption{$\beta = 0.4$}
    \end{subfigure}

    % Row 3
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.41.png}
        \caption{$\beta = 0.41$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.42.png}
        \caption{$\beta = 0.42$}
    \end{subfigure}

    % Row 4
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.43.png}
        \caption{$\beta = 0.43$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.44.png}
        \caption{$\beta = 0.44$}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    % Row 1
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.4407.png}
        \caption{$\beta = 0.4407$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.45.png}
        \caption{$\beta = 0.45$}
    \end{subfigure}

    % Row 2
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.46.png}
        \caption{$\beta = 0.46$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.47.png}
        \caption{$\beta = 0.47$}
    \end{subfigure}

    % Row 3
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.48.png}
        \caption{$\beta = 0.48$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.49.png}
        \caption{$\beta = 0.49$}
    \end{subfigure}

    % Row 4
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.5.png}
        \caption{$\beta = 0.5$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{magnetization_energy_time_series_beta0.6.png}
        \caption{$\beta = 0.6$}
    \end{subfigure}
