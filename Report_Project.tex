...
We also add a small nonzero external field \(h_0\) and we use the finite-difference estimate: 
\[
\chi = \frac{1}{2h_0} \left( \langle M \rangle_{+h_0} - \langle M \rangle_{-h_0}\right)
\]
