...
\subsection{Measure of autocorrelation functions of magnetization, energy and susceptibility}

\subsection{Measure of autocorrelation times near $T_c$}

\subsection{Estimation of the dynamic critical exponent z}
